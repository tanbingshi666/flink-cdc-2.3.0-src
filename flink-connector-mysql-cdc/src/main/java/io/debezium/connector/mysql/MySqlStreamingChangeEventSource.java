...
public class MySqlStreamingChangeEventSource
    ...
    protected void handleEvent(MySqlOffsetContext offsetContext, Event event) {
        ...
        /**
         * 从 EventHeader 事件类型
         * 如果是 insert 或者 update 事件类型为 EventHeaderV4
         */
        ...
        try {
            ...
            /**
             * 执行事件类型对应的 handler
             * 比如 update -> EXT_UPDATE_ROWS -> MySqlStreamingChangeEventSource.handleUpdate()
             *     insert -> EXT_WRITE_ROWS  -> MySqlStreamingChangeEventSource.handleInsert()
             *     delete -> EXT_DELETE_ROWS -> MySqlStreamingChangeEventSource.handleDelete()
             */
            eventHandlers
            ...
            if (context.isRunning()) {
                ...
                try {
                    LOGGER.debug(
                            ...
                            timeout);
                    /**
                     * 连接 mysql binlog 服务并读取对应的 binlog 数据
                     */
