...
public final class MySqlRecordEmitter<T>
    ...
    public MySqlRecordEmitter(
        ...
        // 读取 MySQL 数据反序列化器 默认 JsonDebeziumDeserializationSchema
        this.debeziumDeserializationSchema = debeziumDeserializationSchema;
        this.sourceReaderMetrics = sourceReaderMetrics;
        // 反序列后的数据是否包含表 schema 信息
    ...
    private void emitElement(SourceRecord element, SourceOutput<T> output) throws Exception {
        ...
        // 反序列化 默认 JsonDebeziumDeserializationSchema
        // 同时将反序列后的数据添加到 outputCollector.output(record)
