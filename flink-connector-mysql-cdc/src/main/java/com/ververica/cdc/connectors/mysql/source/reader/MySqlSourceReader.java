...
public class MySqlSourceReader<T>
    ...
    public MySqlSourceReader(
        ...
        super(
                elementQueue,
                /**
                 * 创建 mysql SourceReader subtask 读取数据单线程
                 */
    ...
    public void addSplits(List<MySqlSplit> splits) {
        ...
        for (MySqlSplit split : splits) {
            ...
            /**
             * Add Split: MySqlSnapshotSplit{t
             * ableId=medical.dict,
            ...
            /**
             * 切片信息是 MySqlSnapshotSplit 或者 MySqlSchemalessSnapshotSplit 类型
             */
            if (split.isSnapshotSplit()) {
                MySqlSnapshotSplit snapshotSplit = split.asSnapshotSplit();
                /**
                 * 判断 highWatermark 是否为 null 一般情况下为 null 也即没有被处理
                 */
        ...
        /**
         * 如果 finishedUnackedSplits 不为空则上报 FinishedSnapshotSplitsReportEvent 给 SourceCoordinator
         */
        reportFinishedSnapshotSplitsIfNeed();

        // add all un-finished splits (including binlog split) to SourceReaderBase
        /**
         * 将切片信息传递给 SourceReaderBase
         */
